...
layout: post
type: socratic
title: "Socratic Seminar Lugano 3"
---

## Announcements

Please join us for our next Socratic Seminar at [PoW.space in Lugano](https://pow.space) from 6:00 PM. A special thank you to **PoW.space** for hosting us.

**Location:** [Contrada di Sassello 10, 6900 Lugano, Switzerland](https://maps.app.goo.gl/kNMFrJZXtPzKAzMf9)

Join our [Telegram group](https://t.me/+QVmFPp07Gtw5MGM8)!

## Topics

- [Jack Dorsey adds stablecoin support to Cash App despite Bitcoin loyalty](https://x.com/CoinDesk/status/2031075164213915796?s=20)
- [Ordinals BIP rejected: Ruben Somsen explains the reasoning](https://x.com/SomsenRuben/status/2029515060893106418?s=20)
- [Bitcoin Core: Wallet migration bug in 30.0 & 30.1 can delete all wallet files](https://x.com/bitcoincoreorg/status/2008284092983369886?s=20)
- [Blockstream: Quantum-resistant transaction signing on Liquid using Simplicity](https://blog.blockstream.com/blockstream-research-demonstrates-quantum-resistant-transaction-signing-on-liquid-using-simplicity-smart-contracts/)
